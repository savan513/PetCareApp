...
/**
 * Servlet implementation class HpImageChange
 */
@WebServlet("/HpImageChange")
public class HpImageChange extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HpImageChange() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Uid=(String)session.getAttribute("RepId");
			...
			try {
				...
				for(FileItem item:items)
				{
					...
					PreparedStatement stmt=con.prepareStatement("UPDATE hospital SET  image = ? WHERE Id = ?");  
